...
export default class Utils {
    ...
    public static changeTexture(MeshSpriteObj:Laya.MeshSprite3D, textureUrl:string) {
        let bg1material = MeshSpriteObj.meshRenderer.material as Laya.BlinnPhongMaterial;
        // 换贴图
     ...
     */
     public static getMaterial(MeshSpriteObj:Laya.MeshSprite3D, isSharedMatretial:boolean) {
        if(isSharedMatretial) {
            ...
            var MeshSpriteMaterial = MeshSpriteObj.meshRenderer.sharedMaterial  as Laya.BlinnPhongMaterial;
        }
        else {
            var MeshSpriteMaterial = MeshSpriteObj.meshRenderer.material  as Laya.BlinnPhongMaterial;
        }
