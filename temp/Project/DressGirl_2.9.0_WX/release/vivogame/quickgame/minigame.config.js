...
module.exports = function (options) {
  ...
  const externals = [
	...
	{
		module_name:'./libs/min/laya.ani.min.js',
		module_path:'./libs/min/laya.ani.min.js',
		module_from:'engine/libs/min/laya.ani.min.js'
	},
	{
		module_name:'./libs/min/laya.core.min.js',
		module_path:'./libs/min/laya.core.min.js',
		module_from:'engine/libs/min/laya.core.min.js'
	},
	{
		module_name:'./libs/min/laya.d3.min.js',
		module_path:'./libs/min/laya.d3.min.js',
		module_from:'engine/libs/min/laya.d3.min.js'
	},
	{
		module_name:'./libs/min/laya.physics3D.min.js',
		module_path:'./libs/min/laya.physics3D.min.js',
		module_from:'engine/libs/min/laya.physics3D.min.js'
	},
	{
		module_name:'./libs/min/laya.ui.min.js',
		module_path:'./libs/min/laya.ui.min.js',
		module_from:'engine/libs/min/laya.ui.min.js'
	},
	{
