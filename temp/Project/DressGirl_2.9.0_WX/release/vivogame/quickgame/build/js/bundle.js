(function () {
    ...
    (function (LwgPlatform) {
        ...
        class AD {
            static showVideo(watchCompelet, watchClose) {
                console.debug('播放视频平台类型', LwgPlatform.EmType.TwoTwoThree);
                if (LwgPlatform.type === LwgPlatform.EmType.Exploit || LwgPlatform.type === LwgPlatform.EmType.ExploitNoAD || LwgPlatform.type === LwgPlatform.EmType.WebTest || LwgPlatform.type === LwgPlatform.EmType.WebTestClear) {
                    ...
                    switch (LwgPlatform.type) {
                        case EmType.WeChat:
                            LwgWX.AD && LwgWX.AD.showVideo(watchCompelet, watchClose);
                            break;
                        case EmType.OPPO:
                            LwgOPPO.AD && LwgOPPO.AD.showVideo(watchCompelet, watchClose);
                            break;
                        case EmType.VIVO:
                            LwgVIVO.AD && LwgVIVO.AD.showVideo(watchCompelet, watchClose);
                            break;
                        case EmType.TwoTwoThree:
                            Lwg233.AD && Lwg233.AD.showVideo(watchCompelet, watchClose);
                            break;
                        default:
            ...
            static showNativeByManual() {
                switch (LwgPlatform.type) {
                    case EmType.WeChat:
                        LwgDialogue.showTips('暂无广告！');
                        break;
                    case EmType.OPPO:
                        LwgOPPO.AD && LwgOPPO.AD.showNativeByManual();
                        break;
                    case EmType.VIVO:
                        LwgVIVO.AD && LwgVIVO.AD.showNativeByManual();
                        break;
                    default:
                        LwgDialogue.showTips('暂无广告！');
                        break;
            ...
            static showByOpenScene(sceneName) {
                switch (LwgPlatform.type) {
                    case EmType.WeChat:
                        LwgWX.AD && LwgWX.AD.showByOpenScene(sceneName);
                        break;
                    case EmType.OPPO:
                        LwgOPPO.AD && LwgOPPO.AD.updateCheckShowAllInScene();
                        LwgOPPO.System && LwgOPPO.System.checkShowInstallShortcutBtn(sceneName);
                        break;
                    case EmType.VIVO:
                        LwgVIVO.AD && LwgVIVO.AD.updateCheckShowAllInScene();
                        LwgVIVO.System && LwgVIVO.System.checkShowInstallShortcutBtn(sceneName);
                        break;
                    default:
                        break;
                }
            }
            static showInsertByCloseScene(sceneName) {
                switch (LwgPlatform.type) {
                    case EmType.WeChat:
                        LwgWX.AD && LwgWX.AD.checkShowInsertByCloseScenes(sceneName);
                        break;
                    case EmType.OPPO:
                        break;
                    case EmType.VIVO:
                        LwgVIVO.AD && LwgVIVO.AD.checkShowInsertByCloseScenes(sceneName);
                        break;
                    case EmType.TwoTwoThree:
                        Lwg233.AD && Lwg233.AD.checkShowInsertByCloseScenes(sceneName);
                        break;
                    case EmType.TwoTwoThree:
                        Lwg233.AD && Lwg233.AD.checkShowInsertByCloseScenes(sceneName);
                        break;
            ...
            static showByCloseOverlayScene() {
                switch (LwgPlatform.type) {
                    case EmType.WeChat:
                        LwgWX.AD && LwgWX.AD.showByCloseOverlayScene();
                        break;
                    case EmType.OPPO:
                        LwgOPPO.AD && LwgOPPO.AD.updateCheckShowAllInScene();
                        break;
        ...
        class System {
            static shakeShort() {
                switch (LwgPlatform.type) {
                    case EmType.WeChat:
                        LwgWX.System && LwgWX.System.vibrateShort();
                        break;
                    case EmType.OPPO:
                        LwgOPPO.System && LwgOPPO.System.vibrateShort();
                        break;
                    case EmType.VIVO:
                        LwgVIVO.System && LwgVIVO.System.vibrateShort();
                        break;
                    case EmType.TwoTwoThree:
                        Lwg233.System.shakeShort();
                        break;
                    default:
                        break;
                }
            ...
            static shakeLong() {
                switch (LwgPlatform.type) {
                    case EmType.WeChat:
                        LwgWX.System && LwgWX.System.vibrateLong();
                        break;
                    case EmType.OPPO:
                        LwgOPPO.System && LwgOPPO.System.vibrateLong();
                        break;
                    case EmType.VIVO:
                        LwgVIVO.System && LwgVIVO.System.vibrateLong();
                        break;
                    default:
                        break;
                }
            ...
            static share(watchCompelet) {
                switch (LwgPlatform.type) {
                    case EmType.WeChat:
                        LwgWX.System && LwgWX.System.share(watchCompelet);
                        break;
                    case EmType.OPPO:
                        LwgDialogue.showTips('暂无分享！');
                        break;
                    case EmType.VIVO:
                        LwgDialogue.showTips('暂无分享！');
                        break;
        ...
        class _AD {
            constructor(data) {
                ...
                Laya.timer.once(this.ADData.delayTime, this, () => {
                    this.updateCheckShowAllInScene();
                });
            }
            updateCheckShowAllInScene() {
            ...
            checkShowInsertByCloseScenes(sceneName) { }
    ...
    (function (LwgScene) {
        ...
        class SceneBase extends ScriptBase {
            ...
            setViewShowByOpen() {
                ...
                LwgPlatform.AD.showByOpenScene(this.owner.name);
            }
            ...
            setViewShowByClose() {
                if (this.owner.name !== NameBase.PreLoadCutIn) {
                    LwgPlatform.AD.showInsertByCloseScene(this.owner.name);
                    if (this.isOverlay) {
    ...
    (function (Lwg233) {
        class Init {
            constructor(ADData) {
                Lwg233.AD = new _AD(ADData);
                Lwg233.System = new _System;
            }
        }
        Lwg233.Init = Init;
        class _System {
